...
exports.toDOMFragment = async function (text, filePath, grammar, callback) {
  ...
  // ianschange
  //if (!isAsciidoctor) { await highlightCodeBlocks(domFragment, grammar, makeAtomEditorNonInteractive) };
...
exports.toHTML = async function (text, filePath, grammar) {
  ...
  //
  // // ianschange
  //if (!isAsciidoctor) { await highlightCodeBlocks(div, grammar, convertAtomEditorToStandardElement) };
...
// ianscomment highlightCodeBlocks only called from renderer - not needed for adoc
