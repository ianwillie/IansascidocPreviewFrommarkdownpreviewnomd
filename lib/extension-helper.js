...
function getUserLanguageIds() {
  try {
    let usersLanguageIDs = atom.config.get("iansasciidoc-preview-frommarkdownpreviewnomd.customSyntaxHighlightingLanguageIdentifiers");
...
function getLanguageIds() {
  ...
  let preferredLanguageID = atom.config.get("iansasciidoc-preview-frommarkdownpreviewnomd.syntaxHighlightingLanguageIdentifier");
